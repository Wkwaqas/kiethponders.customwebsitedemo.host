<template>
    <div class="select-form">
        <div class="select-input" style="height: auto" :tabindex="disabled ? -1 : tabindex" ref="toggle" :disabled="disabled"
            ...
            <feather-icon v-if="removable && value && value.id" class="alert-danger float-right" icon="XIcon" @click="removeVal"/>
